...
export default async function CreatorsPage() {
  // Fetch active and featured creators, categories, and admin status in parallel
  const [active, featured, categories, adminStatus] = await Promise.all([
    getAllCreators("ACTIVE"),
    getAllCreators("FEATURED"),
    getAllCategories(),
    isAdmin(),
  ]);
  const creators = [...active, ...featured];
