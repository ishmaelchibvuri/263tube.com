...
export const metadata: Metadata = {
  ...
  description:
    "See who's making waves in Zimbabwe's creator community. Discover the most shared and fastest growing content creators this week.",
};
...
export default async function TrendingPage() {
  ...
  const creators = trendingCreators.length > 0 ? trendingCreators : allCreators;
  ...
  return (
    <div className="min-h-screen bg-[#09090b]">
      ...
      <TrendingPageClient creators={creators} />
